...
![Version: 1.5.0](https://img.shields.io/badge/Version-1.5.0-informational?style=flat-square) ![AppVersion: v6.2](https://img.shields.io/badge/AppVersion-v6.2-informational?style=flat-square)
...
| image.tag | string | `"6.2"` | image tag |
