...
![Version: 1.3.0](https://img.shields.io/badge/Version-1.3.0-informational?style=flat-square) ![AppVersion: 6.0](https://img.shields.io/badge/AppVersion-6.0-informational?style=flat-square)
...
| image.tag | string | `"6.0"` | image tag |
