...
![Version: 2.55.0](https://img.shields.io/badge/Version-2.55.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.112.0](https://img.shields.io/badge/AppVersion-v1.112.0-informational?style=flat-square)
...
| synapse.image.tag | string | `"v1.112.0"` |  |
