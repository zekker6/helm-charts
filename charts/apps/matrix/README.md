...
![Version: 2.22.0](https://img.shields.io/badge/Version-2.22.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.80.0](https://img.shields.io/badge/AppVersion-v1.80.0-informational?style=flat-square)
...
| synapse.image.tag | string | `"v1.80.0"` |  |
