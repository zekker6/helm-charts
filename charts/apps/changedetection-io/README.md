...
![Version: 1.62.0](https://img.shields.io/badge/Version-1.62.0-informational?style=flat-square) ![AppVersion: 0.50.16](https://img.shields.io/badge/AppVersion-0.50.16-informational?style=flat-square)
...
| image.tag | string | `"0.50.16"` | image tag |
