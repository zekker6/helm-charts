...
![Version: 1.33.0](https://img.shields.io/badge/Version-1.33.0-informational?style=flat-square) ![AppVersion: v0.49.1](https://img.shields.io/badge/AppVersion-v0.49.1-informational?style=flat-square)
...
| image.tag | string | `"0.49.1"` | image tag |
