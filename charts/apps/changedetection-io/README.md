...
![Version: 1.102.0](https://img.shields.io/badge/Version-1.102.0-informational?style=flat-square) ![AppVersion: 0.60.7](https://img.shields.io/badge/AppVersion-0.60.7-informational?style=flat-square)
...
| image.tag | string | `"0.60.7"` | image tag |
