...
| addons.codeserver.image.tag | string | `"4.21.1"` | Specify the code-server image tag |
...
| addons.netshoot.image.tag | string | `"v0.12"` | Specify the netshoot image tag |
...
| addons.promtail.image.tag | string | `"2.9.4"` | Specify the promtail image tag |
