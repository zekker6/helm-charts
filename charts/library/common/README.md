...
| addons.codeserver.image.tag | string | `"4.105.1"` | Specify the code-server image tag |
...
| addons.netshoot.image.tag | string | `"v0.14"` | Specify the netshoot image tag |
...
| addons.promtail.image.tag | string | `"3.6.0"` | Specify the promtail image tag |
...
| addons.vpn.gluetun.image.tag | string | `"v3.40.3"` | Specify the Gluetun image tag |
