...
| addons.codeserver.image.tag | string | `"4.93.1"` | Specify the code-server image tag |
...
| addons.netshoot.image.tag | string | `"v0.13"` | Specify the netshoot image tag |
...
| addons.promtail.image.tag | string | `"3.2.1"` | Specify the promtail image tag |
...
| addons.vpn.gluetun.image.tag | string | `"v3.39.1"` | Specify the Gluetun image tag |
