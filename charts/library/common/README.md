...
| addons.codeserver.image.tag | string | `"4.108.2"` | Specify the code-server image tag |
...
| addons.netshoot.image.tag | string | `"v0.15"` | Specify the netshoot image tag |
...
| addons.promtail.image.tag | string | `"3.6.5"` | Specify the promtail image tag |
...
| addons.vpn.gluetun.image.tag | string | `"v3.41.0"` | Specify the Gluetun image tag |
