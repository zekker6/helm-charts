...
![Version: 0.6.0](https://img.shields.io/badge/Version-0.6.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.1.3](https://img.shields.io/badge/AppVersion-v2.1.3-informational?style=flat-square)
...
| https://sentry-kubernetes.github.io/charts | clickhouse | 3.11.0 |
...
| image.tag | string | `"v2.1.3"` | Overrides the image tag whose default is the chart appVersion. See https://hub.docker.com/r/plausible/analytics for tags |
