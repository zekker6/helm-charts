...
![Version: 1.11.0](https://img.shields.io/badge/Version-1.11.0-informational?style=flat-square) ![AppVersion: 6.6](https://img.shields.io/badge/AppVersion-6.6-informational?style=flat-square)
...
| image.tag | string | `"6.6"` | image tag |
