...
![Version: 1.12.1](https://img.shields.io/badge/Version-1.12.1-informational?style=flat-square) ![AppVersion: 6.7-dockerupdate-3](https://img.shields.io/badge/AppVersion-6.7--dockerupdate--3-informational?style=flat-square)
...
| image.tag | string | `"6.7-dockerupdate-3"` | image tag |
