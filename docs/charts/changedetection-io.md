...
![Version: 1.73.0](https://img.shields.io/badge/Version-1.73.0-informational?style=flat-square) ![AppVersion: 0.50.40](https://img.shields.io/badge/AppVersion-0.50.40-informational?style=flat-square)
...
| image.tag | string | `"0.50.40"` | image tag |
