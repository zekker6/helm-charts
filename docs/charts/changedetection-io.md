...
![Version: 1.60.0](https://img.shields.io/badge/Version-1.60.0-informational?style=flat-square) ![AppVersion: 0.50.14](https://img.shields.io/badge/AppVersion-0.50.14-informational?style=flat-square)
...
| image.tag | string | `"0.50.14"` | image tag |
