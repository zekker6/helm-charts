...
![Version: 1.48.0](https://img.shields.io/badge/Version-1.48.0-informational?style=flat-square) ![AppVersion: 0.50.2](https://img.shields.io/badge/AppVersion-0.50.2-informational?style=flat-square)
...
| image.tag | string | `"0.50.2"` | image tag |
