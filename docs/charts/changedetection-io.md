...
![Version: 1.23.0](https://img.shields.io/badge/Version-1.23.0-informational?style=flat-square) ![AppVersion: v0.46.04](https://img.shields.io/badge/AppVersion-v0.46.04-informational?style=flat-square)
...
| image.tag | string | `"0.46.04"` | image tag |
