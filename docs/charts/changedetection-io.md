...
![Version: 1.93.0](https://img.shields.io/badge/Version-1.93.0-informational?style=flat-square) ![AppVersion: 0.55.3](https://img.shields.io/badge/AppVersion-0.55.3-informational?style=flat-square)
...
| image.tag | string | `"0.55.3"` | image tag |
