...
![Version: 1.58.0](https://img.shields.io/badge/Version-1.58.0-informational?style=flat-square) ![AppVersion: 0.50.12](https://img.shields.io/badge/AppVersion-0.50.12-informational?style=flat-square)
...
| image.tag | string | `"0.50.12"` | image tag |
