...
![Version: 1.34.0](https://img.shields.io/badge/Version-1.34.0-informational?style=flat-square) ![AppVersion: v0.49.2](https://img.shields.io/badge/AppVersion-v0.49.2-informational?style=flat-square)
...
| image.tag | string | `"0.49.2"` | image tag |
