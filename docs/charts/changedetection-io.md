...
![Version: 1.51.0](https://img.shields.io/badge/Version-1.51.0-informational?style=flat-square) ![AppVersion: 0.50.5](https://img.shields.io/badge/AppVersion-0.50.5-informational?style=flat-square)
...
| image.tag | string | `"0.50.5"` | image tag |
