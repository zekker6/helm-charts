...
![Version: 1.80.0](https://img.shields.io/badge/Version-1.80.0-informational?style=flat-square) ![AppVersion: 0.52.7](https://img.shields.io/badge/AppVersion-0.52.7-informational?style=flat-square)
...
| image.tag | string | `"0.52.7"` | image tag |
