...
![Version: 1.81.0](https://img.shields.io/badge/Version-1.81.0-informational?style=flat-square) ![AppVersion: 0.52.9](https://img.shields.io/badge/AppVersion-0.52.9-informational?style=flat-square)
...
| image.tag | string | `"0.52.9"` | image tag |
