...
![Version: 1.22.0](https://img.shields.io/badge/Version-1.22.0-informational?style=flat-square) ![AppVersion: v0.46.03](https://img.shields.io/badge/AppVersion-v0.46.03-informational?style=flat-square)
...
| image.tag | string | `"0.46.03"` | image tag |
