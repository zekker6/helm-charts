...
![Version: 1.31.0](https://img.shields.io/badge/Version-1.31.0-informational?style=flat-square) ![AppVersion: v0.48.06](https://img.shields.io/badge/AppVersion-v0.48.06-informational?style=flat-square)
...
| image.tag | string | `"0.48.06"` | image tag |
