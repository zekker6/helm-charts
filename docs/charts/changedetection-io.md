...
![Version: 1.63.0](https://img.shields.io/badge/Version-1.63.0-informational?style=flat-square) ![AppVersion: 0.50.17](https://img.shields.io/badge/AppVersion-0.50.17-informational?style=flat-square)
...
| image.tag | string | `"0.50.17"` | image tag |
