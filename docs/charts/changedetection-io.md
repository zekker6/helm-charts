...
![Version: 1.101.0](https://img.shields.io/badge/Version-1.101.0-informational?style=flat-square) ![AppVersion: 0.60.6](https://img.shields.io/badge/AppVersion-0.60.6-informational?style=flat-square)
...
| image.tag | string | `"0.60.6"` | image tag |
