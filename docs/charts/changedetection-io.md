...
![Version: 1.35.0](https://img.shields.io/badge/Version-1.35.0-informational?style=flat-square) ![AppVersion: v0.49.3](https://img.shields.io/badge/AppVersion-v0.49.3-informational?style=flat-square)
...
| image.tag | string | `"0.49.3"` | image tag |
