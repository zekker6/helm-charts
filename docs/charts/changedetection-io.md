...
![Version: 1.66.0](https://img.shields.io/badge/Version-1.66.0-informational?style=flat-square) ![AppVersion: 0.50.27](https://img.shields.io/badge/AppVersion-0.50.27-informational?style=flat-square)
...
| image.tag | string | `"0.50.27"` | image tag |
