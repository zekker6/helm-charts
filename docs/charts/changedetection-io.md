...
![Version: 1.37.0](https://img.shields.io/badge/Version-1.37.0-informational?style=flat-square) ![AppVersion: 0.49.7](https://img.shields.io/badge/AppVersion-0.49.7-informational?style=flat-square)
...
| image.tag | string | `"0.49.7"` | image tag |
