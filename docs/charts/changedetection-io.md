...
![Version: 1.86.0](https://img.shields.io/badge/Version-1.86.0-informational?style=flat-square) ![AppVersion: 0.54.4](https://img.shields.io/badge/AppVersion-0.54.4-informational?style=flat-square)
...
| image.tag | string | `"0.54.4"` | image tag |
