...
![Version: 1.59.0](https://img.shields.io/badge/Version-1.59.0-informational?style=flat-square) ![AppVersion: 0.50.13](https://img.shields.io/badge/AppVersion-0.50.13-informational?style=flat-square)
...
| image.tag | string | `"0.50.13"` | image tag |
