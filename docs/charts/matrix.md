...
![Version: 3.5.0](https://img.shields.io/badge/Version-3.5.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.139.2](https://img.shields.io/badge/AppVersion-v1.139.2-informational?style=flat-square)
...
| synapse.image.tag | string | `"v1.139.2"` |  |
