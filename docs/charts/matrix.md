...
![Version: 2.53.0](https://img.shields.io/badge/Version-2.53.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.110.0](https://img.shields.io/badge/AppVersion-v1.110.0-informational?style=flat-square)
...
| synapse.image.tag | string | `"v1.110.0"` |  |
