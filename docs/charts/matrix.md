...
![Version: 2.70.0](https://img.shields.io/badge/Version-2.70.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.125.0](https://img.shields.io/badge/AppVersion-v1.125.0-informational?style=flat-square)
...
| synapse.image.tag | string | `"v1.125.0"` |  |
